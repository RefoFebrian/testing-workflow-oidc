...
class PrintGoodsReceiptStockPickingBatch(models.AbstractModel):
    _name = "report.tw_stock.batch_goods_receipt_template"
    _description = "Stock Picking Batch Report Bukti Penerimaan Barang"
