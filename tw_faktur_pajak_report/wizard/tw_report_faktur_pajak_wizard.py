...
class TWReportFakturPajak(models.TransientModel):
    """Wizard for generating various Faktur Pajak reports."""

    _name = "tw.report.faktur.pajak"
    _description = "TW Report Faktur Pajak"
    ...
    division = fields.Selection(
        selection=lambda self: self.env['tw.selection'].get_division_options_list(['Unit', 'Sparepart', 'Umum']),
        string='Division',
        default='Unit'
    )
    ...
    def _check_date_range_limit(self, start_date, end_date):
        """Validate date range does not exceed limit."""
    ...
    def _print_excel_report_faktur_pajak(self):
        """Generate Faktur Pajak report data."""
