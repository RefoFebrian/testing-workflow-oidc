...
class PrintProposalReport(models.AbstractModel):
    _name = "report.tw_proposal.proposal_report"
    _description = "Proposal Report"
    ...
    def _get_report_values(self, docids, data=None):
        docs = self.env['tw.proposal'].browse(docids)

        return {
            'doc_ids': docids,
            'doc_model': 'tw.proposal',
            'docs': docs,
