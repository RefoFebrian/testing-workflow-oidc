...
class TwVehicleOwnershipHandoverReport(models.AbstractModel):
    _name = "report.tw_vehicle_document_handover.own_handover_report"
    _description = "Vehicle Ownership Handover Report Parser"
