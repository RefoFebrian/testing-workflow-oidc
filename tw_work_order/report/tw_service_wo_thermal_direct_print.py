...
class PrintWorkOrderPickingThermal(models.AbstractModel):
    _name = "report.tw_work_order.print_service_wo_direct_print"
    _description = "Work Order Print Thermal"
    ...
    def dealer_address(self):
        ...
        dealer_name = ["", "", "", "", "", "", "", "", ""]
        if work_order_obj.partner_id:
            dealer_name = [
                work_order_obj.partner_id.name,
                work_order_obj.partner_id.street,
                work_order_obj.partner_id.rt,
                work_order_obj.partner_id.rw,
                work_order_obj.partner_id.sub_district_id.name,
                work_order_obj.partner_id.district_id.name,
                work_order_obj.partner_id.city_id.name,
                work_order_obj.partner_id.state_id.name,
                work_order_obj.partner_id.mobile
            ]
        return dealer_name
    ...
    def print_counter(self):
        ...
        report_id = self.env.ref('tw_work_order.print_wo_picking_list').id
    ...
    def _get_report_values(self, docids, data=None):
        docs = self.env['tw.work.order'].browse(docids)
