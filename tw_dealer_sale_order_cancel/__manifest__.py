# -*- coding: utf-8 -*-
{
    'name': "TW Dealer Sale Order Cancel",

    'summary': "Module to manage and handle dealer sale order cancellations effectively.",

    'description': """
This module provides functionality to manage the cancellation of dealer sale orders in Odoo. 
...
- Streamlined cancellation process for dealer sale orders.
    ...
    'data': [
        ...
        'views/tw_dealer_sale_order_cancel_view.xml',
