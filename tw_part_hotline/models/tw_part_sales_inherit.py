...
class TwPartSales(models.Model):
    ...
    def action_view_part_hotline(self):
        """View hotline records linked to this PS's order lines."""
    ...
    def action_request_approval(self):
        ...
        return super(TwPartSales, self).action_request_approval()

    def action_approval(self):
        self._check_qty_available_in_hotline_detail()
        return super(TwPartSales, self).action_approval()
