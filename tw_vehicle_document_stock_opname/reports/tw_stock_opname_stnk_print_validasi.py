...
class TwStockOpnameStnkPrintValidasi(models.AbstractModel):
    _name = "report.tw_vehicle_document_stock_opname.stnk_print_validasi"
    _description = "Stock Opname STNK Validasi Report"
    ...
    def _get_report_values(self, docids, data=None):
        ...
        return {
            ...
            'get_stnk_other': lambda d: d.get('other_stnk_ids'),
