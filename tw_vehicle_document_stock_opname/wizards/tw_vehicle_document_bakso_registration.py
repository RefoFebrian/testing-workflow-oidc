...
class TwVehicleDocumentBaksoRegistration(models.TransientModel):
    _name = "tw.vehicle.document.bakso.registration"
    _description = "Vehicle Document Bakso Registration"
    ...
    def action_submit_bakso(self):
        ...
        saldo_sistem = len(self.opname_id.detail_stnk_ids)
        saldo_cabang = 0
        saldo_ho = 0
        saldo_md = 0
        saldo_birojasa = 0
        ...
        for line in self.opname_id.detail_stnk_ids:
            if line.validation_check_physical_registration == 'Fisik Ada':
                saldo_cabang += 1
            elif line.validation_check_physical_registration == 'Fisik di HO':
                saldo_ho += 1
            elif line.validation_check_physical_registration == 'Revisi Biro Jasa':
                saldo_birojasa += 1
            elif line.validation_check_physical_registration == 'Sudah Penyerahan ke Konsumen':
                saldo_konsumen += 1
            elif line.validation_check_physical_registration == 'Hilang / Fisik tidak diketahui':
                saldo_lainnya += 1
        ...
        return self.env.ref('tw_vehicle_document_stock_opname.action_report_bakso_stnk').report_action(self, data=datas)
