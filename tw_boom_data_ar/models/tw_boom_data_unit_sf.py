...
class TWBoomDataARSF(models.Model):
    _inherit = "tw.boom.task"
    _description = "TW Boom Data AR SF"
    _order = "id desc"
    ...
    # 14: private methods
    def schedule_generate_data_ar_unit_sf(self, limit=100, start_date=None, end_date=None, branch_code=None, source_transaksi=None, no_transaksi=None):
        query_where = ""
        query_limit = ""
        query_date = ""
        query_branch = ""
        ...
        query = """
            SELECT 
                b.id AS company_id
                , 'Pelunasan Subsidi Finco (SF)' AS kategori
                , NULL AS product_id
            ...
            AND aj.name->>'en_US' = 'Journal PS Finco'
            {query_where}
            {query_branch}
            {query_date}
