# -*- coding: utf-8 -*-
{
    'name': "TW Purchase Order Report",

    'summary': "Purchasing Report",
    ...
    'depends': ['base', 'tw_purchase_order', 'purchase', 'stock', 'tw_base', 'tw_selection', 'tw_menu', 'web_report', 'tw_stock'],
    ...
    'data': [
        ...
        'template/tw_purchase_order_template.xml',

        'views/tw_purchase_order_report_view.xml',
        'views/tw_purchase_order_report_pdf_view.xml',
        'views/tw_purchase_order_report_print_view.xml',
