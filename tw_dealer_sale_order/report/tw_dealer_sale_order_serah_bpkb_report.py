...
class PrintSerahBPKBDealerSaleOrder(models.AbstractModel):
    _name = "report.tw_dealer_sale_order.serah_bpkb_dso_template"
    _description = "Dealer Sale Order Report Serah BPKB"
