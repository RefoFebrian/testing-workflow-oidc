...
class PrintSettlementAdvancePaymentReport(models.AbstractModel):
    _name = "report.tw_settlement.settlement_advance_payment_report"
    _description = "Advance Payment Report Report"
    ...
    def _get_report_values(self, docids, data=None):
        docs = self.env['tw.settlement'].browse(docids)

        return {
            'doc_ids': docids,
            'doc_model': 'tw.settlement',
            'docs': docs,
