...
class TwApprovalMatrixReport(models.TransientModel):
    ...
    # 14: Private Methods
    def export_report_discount_config(self):
        where = " WHERE 1=1"    
        if self.company_ids:
        ...
        data_sheet = {}
        for data in data:
            if data['product_template_code'] not in data_sheet:
                data_sheet[data['product_template_code']] = []
            data_sheet[data['product_template_code']].append(data)
